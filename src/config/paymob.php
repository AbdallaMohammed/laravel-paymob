...
return [
    ...
    */
    ...
    'authentication_token_endpoint' => env('PAYMOB_AUTHENTICATION_TOKEN_ENDPOINT', 'https://accept.paymobsolutions.com/api/auth/tokens'),
    'create_order_endpoint' => env('CREATE_ORDER_ENDPOINT', 'https://accept.paymobsolutions.com/api/ecommerce/orders'),
    'payment_key_token_endpoint' => env('PAYMENT_KEY_TOKEN_ENDPOINT', 'https://accept.paymobsolutions.com/api/acceptance/payment_keys')
];
